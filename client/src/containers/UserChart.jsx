...
class UserChart extends Component {
    ...
    this.getData('users')
      .then((results) => {
        ...
        results.data.forEach((record) => {
          ...
          data.push(parseInt(record.user_count));
        });
  ...
  render() {
    return <div style={{fontFamily:'sans-serif',fontSize:'2em', 'fontColor': 'black'}}><Chart onClick={this.updateSeries} width={800} height={400} series={this.state.series} minY={0}>
